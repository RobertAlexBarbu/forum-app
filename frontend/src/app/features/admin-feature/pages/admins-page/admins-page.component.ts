...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AdminComponent, ButtonModule, NgIcon, FormsModule, InputTextModule, ModalComponent, PaginatorModule, ReactiveFormsModule],
...
export class AdminsPageComponent {
  ...
  addAdmin() {
    if(this.addAdminForm.valid) {
     this.adminService.updateToAdmin({username: this.addAdminForm.getRawValue()}).subscribe({
       next: (data) => {
